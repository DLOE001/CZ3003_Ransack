...
class Quiz:
    def __init__(self, question, answer, dummy1, dummy2, dummy3):
        ...
        self.text2 = pygame.font.SysFont('Broadway', 20).render("A) " + self.answers[0], True, (0, 0, 0))
        self.text2_position = self.text2.get_rect().move(120,815)
        self.text3 = pygame.font.SysFont('Broadway', 20).render("B) " + self.answers[1], True, (0, 0, 0))
        self.text3_position = self.text3.get_rect().move(self.text2_position.right + 100,815)
        self.text4 = pygame.font.SysFont('Broadway', 20).render("C) " + self.answers[2], True, (0, 0, 0))
        self.text4_position = self.text4.get_rect().move(self.text3_position.right + 100,815)
        self.text5 = pygame.font.SysFont('Broadway', 20).render("D) " + self.answers[3], True, (0, 0, 0))
        self.text5_position = self.text5.get_rect().move(self.text4_position.right + 100,815)
        #Background
